...
`),n}_s.parse=ko;}),$e=ee(k=>{var p=le();function vo(t,e,n){return n?`#${n.replace(/[\s\S]^/gm,`$&${e}#`)}
...
`)+`
`}};Y._defineProperty(en,"defaults",ui),tn.Document=en,tn.defaultOptions=Aa,tn.scalarOptions=Ta;}),gi=ee(hi=>{var zn=xs(),Ne=pi(),xa=Hn(),Ra=le(),Da=jn();$e();function Ya(t,e=!0,n){n===void 0&&typeof e=="string"&&(n=e,e=!0);let r=Object.assign({},Ne.Document.defaults[Ne.defaultOptions.version],Ne.defaultOptions);return new xa.Schema(r).createNode(t,e,n)}var Ke=class extends Ne.Document{constructor(e){super(Object.assign({},Ne.defaultOptions,e));}};function Ba(t,e){let n=[],r;for(let s of zn.parse(t)){let i=new Ke(e);i.parse(s,r),n.push(i),r=i;}return n}function mi(t,e){let n=zn.parse(t),r=new Ke(e).parse(n[0]);if(n.length>1){let s="Source contains multiple documents; please use YAML.parseAllDocuments()";r.errors.unshift(new Ra.YAMLSemanticError(n[1],s));}return r}function $a(t,e){let n=mi(t,e);if(n.warnings.forEach(r=>Da.warn(r)),n.errors.length>0)throw n.errors[0];return n.toJSON()}function Fa(t,e){let n=new Ke(e);return n.contents=t,String(n)}var qa={createNode:Ya,defaultOptions:Ne.defaultOptions,Document:Ke,parse:$a,parseAllDocuments:Ba,parseCST:zn.parse,parseDocument:mi,scalarOptions:Ne.scalarOptions,stringify:Fa};hi.YAML=qa;}),yi=ee((Rm,di)=>{di.exports=gi().YAML;}),Ei=ee(J=>{var Ve=$e(),We=le();J.findPair=Ve.findPair,J.parseMap=Ve.resolveMap,J.parseSeq=Ve.resolveSeq,J.stringifyNumber=Ve.stringifyNumber,J.stringifyString=Ve.stringifyString,J.toJSON=Ve.toJSON,J.Type=We.Type,J.YAMLError=We.YAMLError,J.YAMLReferenceError=We.YAMLReferenceError,J.YAMLSemanticError=We.YAMLSemanticError,J.YAMLSyntaxError=We.YAMLSyntaxError,J.YAMLWarning=We.YAMLWarning;}),tr={};nr(tr,{languages:()=>Pr,options:()=>_r,parsers:()=>er,printers:()=>Ja});var Ii=(t,e,n,r)=>{if(!(t&&e==null))return e.replaceAll?e.replaceAll(n,r):n.global?e.replace(n,r):e.split(n).join(r)},yt=Ii,je="string",Qe="array",Je="cursor",Ge="indent",Oe="align",He="trim",Le="group",Ae="fill",Te="if-break",Xe="indent-if-break",Ce="line-suffix",ze="line-suffix-boundary",te="line",Ze="label",Me="break-parent",Et=new Set([Je,Ge,Oe,He,Le,Ae,Te,Xe,Ce,ze,te,Ze,Me]);function Pi(t){if(typeof t=="string")return je;if(Array.isArray(t))return Qe;if(!t)return;let{type:e}=t;if(Et.has(e))return e}var et=Pi,_i=t=>new Intl.ListFormat("en-US",{type:"disjunction"}).format(t);function xi(t){let e=t===null?"null":typeof t;if(e!=="string"&&e!=="object")return `Unexpected doc '${e}', 
