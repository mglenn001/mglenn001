...
var ri=Object.defineProperty,Xr=t8=>{throw TypeError(t8)},Jr=(t8,e)=>{for(var r in e)ri(t8,r,{get:e[r],enumerable:!0});},Zr=(t8,e,r)=>e.has(t8)||Xr("Cannot "+r),K=(t8,e,r)=>(Zr(t8,e,"read from private field"),r?r.call(t8):e.get(t8)),en=(t8,e,r)=>e.has(t8)?Xr("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t8):e.set(t8,r),tn=(t8,e,r,n)=>(Zr(t8,e,"write to private field"),n?n.call(t8,r):e.set(t8,r),r),Yr={};Jr(Yr,{languages:()=>As,options:()=>vs,parsers:()=>Gr,printers:()=>Io});var ni=(t8,e,r,n)=>{if(!(t8&&e==null))return e.replaceAll?e.replaceAll(r,n):r.global?e.replace(r,n):e.split(r).join(n)},w=ni,Ve="string",Ue="array",We="cursor",De="indent",ve="align",ze="trim",ye="group",we="fill",be="if-break",Te="indent-if-break",Ge="line-suffix",Ye="line-suffix-boundary",Q="line",je="label",xe="break-parent",St=new Set([We,De,ve,ze,ye,we,be,Te,Ge,Ye,Q,je,xe]);function si(t8){if(typeof t8=="string")return Ve;if(Array.isArray(t8))return Ue;if(!t8)return;let{type:e}=t8;if(St.has(e))return e}var Ke=si,ii=t8=>new Intl.ListFormat("en-US",{type:"disjunction"}).format(t8);function ai(t8){let e=t8===null?"null":typeof t8;if(e!=="string"&&e!=="object")return `Unexpected doc '${e}', 
Expected it to be 'string' or 'object'.`;if(Ke(t8))throw new Error("doc is valid.");let r=Object.prototype.toString.call(t8);if(r!=="[object Object]")return `Unexpected doc '${r}'.`;let n=ii([...St].map(s=>`'${s}'`));return `Unexpected doc.type '${t8.type}'.
Expected it to be ${n}.`}var or=class extends Error{name="InvalidDocError";constructor(e){super(ai(e)),this.doc=e;}},ur=or,rn=()=>{},_t=rn;function k(t8){return {type:De,contents:t8}}function nn(t8,e){return {type:ve,contents:e,n:t8}}function _(t8,e={}){return _t(e.expandedStates),{type:ye,id:e.id,contents:t8,break:!!e.shouldBreak,expandedStates:e.expandedStates}}function sn(t8){return nn(Number.NEGATIVE_INFINITY,t8)}function an(t8){return nn({type:"root"},t8)}function Et(t8){return {type:we,parts:t8}}function le(t8,e="",r={}){return {type:be,breakContents:t8,flatContents:e,groupId:r.groupId}}function on(t8,e){return {type:Te,contents:t8,groupId:e.groupId,negate:e.negate}}var ne={type:xe},oi={type:Q,hard:!0},ui={type:Q,hard:!0,literal:!0},E={type:Q},v={type:Q,soft:!0},S=[oi,ne],un=[ui,ne];function q(t8,e){let r=[];for(let n=0;n<e.length;n++)n!==0&&r.push(t8),r.push(e[n]);return r}var li=(t8,e,r)=>{if(!(t8&&e==null))return Array.isArray(e)||typeof e=="string"?e[r<0?e.length+r:r]:e.at(r)},se=li;function lr(t8,e){if(typeof t8=="string")return e(t8);let r=new Map;return n(t8);function n(i){if(r.has(i))return r.get(i);let a=s(i);return r.set(i,a),a}function s(i){switch(Ke(i)){case Ue:return e(i.map(n));case we:return e({...i,parts:i.parts.map(n)});case be:return e({...i,breakContents:n(i.breakContents),flatContents:n(i.flatContents)});case ye:{let{expandedStates:a,contents:o}=i;return a?(a=a.map(n),o=a[0]):o=n(o),e({...i,contents:o,expandedStates:a})}case ve:case De:case Te:case je:case Ge:return e({...i,contents:n(i.contents)});case Ve:case We:case ze:case Ye:case Q:case xe:return e(i);default:throw new ur(i)}}}function B(t8,e=un){return lr(t8,r=>typeof r=="string"?q(e,r.split(`
`)):r)}var At="'",ln='"';function ci(t8,e){let r=e===!0||e===At?At:ln,n=r===At?ln:At,s=0,i=0;for(let a of t8)a===r?s++:a===n&&i++;return s>i?n:r}var cn=ci;function cr(t8){if(typeof t8!="string")throw new TypeError("Expected a string");return t8.replace(/[|\\{}()[\]^$+*?.]/g,"\\$&").replace(/-/g,"\\x2d")}var H,pr=class{constructor(e){en(this,H),tn(this,H,new Set(e));}getLeadingWhitespaceCount(e){let r=K(this,H),n=0;for(let s=0;s<e.length&&r.has(e.charAt(s));s++)n++;return n}getTrailingWhitespaceCount(e){let r=K(this,H),n=0;for(let s=e.length-1;s>=0&&r.has(e.charAt(s));s--)n++;return n}getLeadingWhitespace(e){let r=this.getLeadingWhitespaceCount(e);return e.slice(0,r)}getTrailingWhitespace(e){let r=this.getTrailingWhitespaceCount(e);return e.slice(e.length-r)}hasLeadingWhitespace(e){return K(this,H).has(e.charAt(0))}hasTrailingWhitespace(e){return K(this,H).has(se(!1,e,-1))}trimStart(e){let r=this.getLeadingWhitespaceCount(e);return e.slice(r)}trimEnd(e){let r=this.getTrailingWhitespaceCount(e);return e.slice(0,e.length-r)}trim(e){return this.trimEnd(this.trimStart(e))}split(e,r=!1){let n=`[${cr([...K(this,H)].join(""))}]+`,s=new RegExp(r?`(${n})`:n,"u");return e.split(s)}hasWhitespaceCharacter(e){let r=K(this,H);return Array.prototype.some.call(e,n=>r.has(n))}hasNonWhitespaceCharacter(e){let r=K(this,H);return Array.prototype.some.call(e,n=>!r.has(n))}isWhitespaceOnly(e){let r=K(this,H);return Array.prototype.every.call(e,n=>r.has(n))}};H=new WeakMap;var pn=pr,pi=["	",`
`,"\f","\r"," "],hi=new pn(pi),N=hi,hr=class extends Error{name="UnexpectedNodeError";constructor(e,r,n="type"){super(`Unexpected ${r} node ${n}: ${JSON.stringify(e[n])}.`),this.node=e;}},hn=hr;function mi(t8){return t8?.type==="front-matter"}var ke=mi,fi=new Set(["sourceSpan","startSourceSpan","endSourceSpan","nameSpan","valueSpan","keySpan","tagDefinition","tokens","valueTokens","switchValueSourceSpan","expSourceSpan","valueSourceSpan"]),di=new Set(["if","else if","for","switch","case"]);function mn(t8,e){var r;if(t8.type==="text"||t8.type==="comment"||ke(t8)||t8.type==="yaml"||t8.type==="toml")return null;if(t8.type==="attribute"&&delete e.value,t8.type==="docType"&&delete e.value,t8.type==="angularControlFlowBlock"&&(r=t8.parameters)!=null&&r.children)for(let n of e.parameters.children)di.has(t8.name)?delete n.expression:n.expression=n.expression.trim();t8.type==="angularIcuExpression"&&(e.switchValue=t8.switchValue.trim()),t8.type==="angularLetDeclarationInitializer"&&delete e.value;}mn.ignoredProperties=fi;var fn=mn;async function gi(t8,e){if(t8.language==="yaml"){let r=t8.value.trim(),n=r?await e(r,{parser:"yaml"}):"";return an([t8.startDelimiter,t8.explicitLanguage,S,n,n?S:"",t8.endDelimiter])}}var dn=gi;function ce(t8,e=!0){return [k([v,t8]),e?v:""]}function Y(t8,e){let r=t8.type==="NGRoot"?t8.node.type==="NGMicrosyntax"&&t8.node.body.length===1&&t8.node.body[0].type==="NGMicrosyntaxExpression"?t8.node.body[0].expression:t8.node:t8.type==="JsExpressionRoot"?t8.node:t8;return r&&(r.type==="ObjectExpression"||r.type==="ArrayExpression"||(e.parser==="__vue_expression"||e.parser==="__vue_ts_expression")&&(r.type==="TemplateLiteral"||r.type==="StringLiteral"))}async function T(t8,e,r,n){r={__isInHtmlAttribute:!0,__embeddedInHtml:!0,...r};let s=!0;n&&(r.__onHtmlBindingRoot=(a,o)=>{s=n(a,o);});let i=await e(t8,r,e);return s?_(i):ce(i)}function Ci(t8,e,r,n){let{node:s}=r,i=n.originalText.slice(s.sourceSpan.start.offset,s.sourceSpan.end.offset);return /^\s*$/u.test(i)?"":T(i,t8,{parser:"__ng_directive",__isInHtmlAttribute:!1},Y)}var gn=Ci,Si=t8=>String(t8).split(/[/\\]/u).pop();function Cn(t8,e){if(!e)return;let r=Si(e).toLowerCase();return t8.find(({filenames:n})=>n?.some(s=>s.toLowerCase()===r))??t8.find(({extensions:n})=>n?.some(s=>r.endsWith(s)))}function _i(t8,e){if(e)return t8.find(({name:r})=>r.toLowerCase()===e)??t8.find(({aliases:r})=>r?.includes(e))??t8.find(({extensions:r})=>r?.includes(`.${e}`))}function Ei(t8,e){let r=t8.plugins.flatMap(s=>s.languages??[]),n=_i(r,e.language)??Cn(r,e.physicalFile)??Cn(r,e.file)??(e.physicalFile,void 0);return n?.parsers[0]}var Be=Ei,Sn="inline",_n={area:"none",base:"none",basefont:"none",datalist:"none",head:"none",link:"none",meta:"none",noembed:"none",noframes:"none",param:"block",rp:"none",script:"block",style:"none",template:"inline",title:"none",html:"block",body:"block",address:"block",blockquote:"block",center:"block",dialog:"block",div:"block",figure:"block",figcaption:"block",footer:"block",form:"block",header:"block",hr:"block",legend:"block",listing:"block",main:"block",p:"block",plaintext:"block",pre:"block",search:"block",xmp:"block",slot:"contents",ruby:"ruby",rt:"ruby-text",article:"block",aside:"block",h1:"block",h2:"block",h3:"block",h4:"block",h5:"block",h6:"block",hgroup:"block",nav:"block",section:"block",dir:"block",dd:"block",dl:"block",dt:"block",menu:"block",ol:"block",ul:"block",li:"list-item",table:"table",caption:"table-caption",colgroup:"table-column-group",col:"table-column",thead:"table-header-group",tbody:"table-row-group",tfoot:"table-footer-group",tr:"table-row",td:"table-cell",th:"table-cell",input:"inline-block",button:"inline-block",fieldset:"block",details:"block",summary:"block",marquee:"inline-block",source:"block",track:"block",meter:"inline-block",progress:"inline-block",object:"inline-block",video:"inline-block",audio:"inline-block",select:"inline-block",option:"block",optgroup:"block"},En="normal",An={listing:"pre",plaintext:"pre",pre:"pre",xmp:"pre",nobr:"nowrap",table:"initial",textarea:"pre-wrap"};function Ai(t8){return t8.type==="element"&&!t8.hasExplicitNamespace&&!["html","svg"].includes(t8.namespace)}var pe=Ai,Di=t8=>w(!1,t8,/^[\t\f\r ]*\n/gu,""),mr=t8=>Di(N.trimEnd(t8)),Dn=t8=>{let e=t8,r=N.getLeadingWhitespace(e);r&&(e=e.slice(r.length));let n=N.getTrailingWhitespace(e);return n&&(e=e.slice(0,-n.length)),{leadingWhitespace:r,trailingWhitespace:n,text:e}};function Dt(t8,e){return !!(t8.type==="ieConditionalComment"&&t8.lastChild&&!t8.lastChild.isSelfClosing&&!t8.lastChild.endSourceSpan||t8.type==="ieConditionalComment"&&!t8.complete||he(t8)&&t8.children.some(r=>r.type!=="text"&&r.type!=="interpolation")||wt(t8,e)&&!U(t8)&&t8.type!=="interpolation")}function me(t8){return t8.type==="attribute"||!t8.parent||!t8.prev?!1:vi(t8.prev)}function vi(t8){return t8.type==="comment"&&t8.value.trim()==="prettier-ignore"}function O(t8){return t8.type==="text"||t8.type==="comment"}function U(t8){return t8.type==="element"&&(t8.fullName==="script"||t8.fullName==="style"||t8.fullName==="svg:style"||t8.fullName==="svg:script"||pe(t8)&&(t8.name==="script"||t8.name==="style"))}function vn(t8){return t8.children&&!U(t8)}function yn(t8){return U(t8)||t8.type==="interpolation"||fr(t8)}function fr(t8){return In(t8).startsWith("pre")}function wn(t8,e){var s,i;let r=n();if(r&&!t8.prev&&(i=(s=t8.parent)==null?void 0:s.tagDefinition)!=null&&i.ignoreFirstLf)return t8.type==="interpolation";return r;function n(){return ke(t8)||t8.type==="angularControlFlowBlock"?!1:(t8.type==="text"||t8.type==="interpolation")&&t8.prev&&(t8.prev.type==="text"||t8.prev.type==="interpolation")?!0:!t8.parent||t8.parent.cssDisplay==="none"?!1:he(t8.parent)?!0:!(!t8.prev&&(t8.parent.type==="root"||he(t8)&&t8.parent||U(t8.parent)||Je(t8.parent,e)||!ki(t8.parent.cssDisplay))||t8.prev&&!Fi(t8.prev.cssDisplay))}}function bn(t8,e){return ke(t8)||t8.type==="angularControlFlowBlock"?!1:(t8.type==="text"||t8.type==="interpolation")&&t8.next&&(t8.next.type==="text"||t8.next.type==="interpolation")?!0:!t8.parent||t8.parent.cssDisplay==="none"?!1:he(t8.parent)?!0:!(!t8.next&&(t8.parent.type==="root"||he(t8)&&t8.parent||U(t8.parent)||Je(t8.parent,e)||!Bi(t8.parent.cssDisplay))||t8.next&&!Li(t8.next.cssDisplay))}function Tn(t8){return Ni(t8.cssDisplay)&&!U(t8)}function Qe(t8){return ke(t8)||t8.next&&t8.sourceSpan.end&&t8.sourceSpan.end.line+1<t8.next.sourceSpan.start.line}function xn(t8){return dr(t8)||t8.type==="element"&&t8.children.length>0&&(["body","script","style"].includes(t8.name)||t8.children.some(e=>wi(e)))||t8.firstChild&&t8.firstChild===t8.lastChild&&t8.firstChild.type!=="text"&&Bn(t8.firstChild)&&(!t8.lastChild.isTrailingSpaceSensitive||Ln(t8.lastChild))}function dr(t8){return t8.type==="element"&&t8.children.length>0&&(["html","head","ul","ol","select"].includes(t8.name)||t8.cssDisplay.startsWith("table")&&t8.cssDisplay!=="table-cell")}function vt(t8){return Fn(t8)||t8.prev&&yi(t8.prev)||kn(t8)}function yi(t8){return Fn(t8)||t8.type==="element"&&t8.fullName==="br"||kn(t8)}function kn(t8){return Bn(t8)&&Ln(t8)}function Bn(t8){return t8.hasLeadingSpaces&&(t8.prev?t8.prev.sourceSpan.end.line<t8.sourceSpan.start.line:t8.parent.type==="root"||t8.parent.startSourceSpan.end.line<t8.sourceSpan.start.line)}function Ln(t8){return t8.hasTrailingSpaces&&(t8.next?t8.next.sourceSpan.start.line>t8.sourceSpan.end.line:t8.parent.type==="root"||t8.parent.endSourceSpan&&t8.parent.endSourceSpan.start.line>t8.sourceSpan.end.line)}function Fn(t8){switch(t8.type){case"ieConditionalComment":case"comment":case"directive":return !0;case"element":return ["script","select"].includes(t8.name)}return !1}function yt(t8){return t8.lastChild?yt(t8.lastChild):t8}function wi(t8){var e;return (e=t8.children)==null?void 0:e.some(r=>r.type!=="text")}function Nn(t8){if(t8)switch(t8){case"module":case"text/javascript":case"text/babel":case"application/javascript":return "babel";case"application/x-typescript":return "typescript";case"text/markdown":return "markdown";case"text/html":return "html";case"text/x-handlebars-template":return "glimmer";default:if(t8.endsWith("json")||t8.endsWith("importmap")||t8==="speculationrules")return "json"}}function bi(t8,e){let{name:r,attrMap:n}=t8;if(r!=="script"||Object.prototype.hasOwnProperty.call(n,"src"))return;let{type:s,lang:i}=t8.attrMap;return !i&&!s?"babel":Be(e,{language:i})??Nn(s)}function Ti(t8,e){if(!wt(t8,e))return;let{attrMap:r}=t8;if(Object.prototype.hasOwnProperty.call(r,"src"))return;let{type:n,lang:s}=r;return Be(e,{language:s})??Nn(n)}function xi(t8,e){if(t8.name!=="style")return;let{lang:r}=t8.attrMap;return r?Be(e,{language:r}):"css"}function gr(t8,e){return bi(t8,e)??xi(t8,e)??Ti(t8,e)}function Xe(t8){return t8==="block"||t8==="list-item"||t8.startsWith("table")}function ki(t8){return !Xe(t8)&&t8!=="inline-block"}function Bi(t8){return !Xe(t8)&&t8!=="inline-block"}function Li(t8){return !Xe(t8)}function Fi(t8){return !Xe(t8)}function Ni(t8){return !Xe(t8)&&t8!=="inline-block"}function he(t8){return In(t8).startsWith("pre")}function Pi(t8,e){let r=t8;for(;r;){if(e(r))return !0;r=r.parent;}return !1}function Pn(t8,e){var n;if(fe(t8,e))return "block";if(((n=t8.prev)==null?void 0:n.type)==="comment"){let s=t8.prev.value.match(/^\s*display:\s*([a-z]+)\s*$/u);if(s)return s[1]}let r=!1;if(t8.type==="element"&&t8.namespace==="svg")if(Pi(t8,s=>s.fullName==="svg:foreignObject"))r=!0;else return t8.name==="svg"?"inline-block":"block";switch(e.htmlWhitespaceSensitivity){case"strict":return "inline";case"ignore":return "block";default:return t8.type==="element"&&(!t8.namespace||r||pe(t8))&&_n[t8.name]||Sn}}function In(t8){return t8.type==="element"&&(!t8.namespace||pe(t8))&&An[t8.name]||En}function Ii(t8){let e=Number.POSITIVE_INFINITY;for(let r of t8.split(`
`)){if(r.length===0)continue;let n=N.getLeadingWhitespaceCount(r);if(n===0)return 0;r.length!==n&&n<e&&(e=n);}return e===Number.POSITIVE_INFINITY?0:e}function Cr(t8,e=Ii(t8)){return e===0?t8:t8.split(`
`).map(r=>r.slice(e)).join(`
`)}function Sr(t8){return w(!1,w(!1,t8,"&apos;","'"),"&quot;",'"')}function P(t8){return Sr(t8.value)}var Ri=new Set(["template","style","script"]);function Je(t8,e){return fe(t8,e)&&!Ri.has(t8.fullName)}function fe(t8,e){return e.parser==="vue"&&t8.type==="element"&&t8.parent.type==="root"&&t8.fullName.toLowerCase()!=="html"}function wt(t8,e){return fe(t8,e)&&(Je(t8,e)||t8.attrMap.lang&&t8.attrMap.lang!=="html")}function Rn(t8){let e=t8.fullName;return e.charAt(0)==="#"||e==="slot-scope"||e==="v-slot"||e.startsWith("v-slot:")}function On(t8,e){let r=t8.parent;if(!fe(r,e))return !1;let n=r.fullName,s=t8.fullName;return n==="script"&&s==="setup"||n==="style"&&s==="vars"}function bt(t8,e=t8.value){return t8.parent.isWhitespaceSensitive?t8.parent.isIndentationSensitive?B(e):B(Cr(mr(e)),S):q(E,N.split(e))}function Tt(t8,e){return fe(t8,e)&&t8.name==="script"}var _r=/\{\{(.+?)\}\}/su;async function $n(t8,e){let r=[];for(let[n,s]of t8.split(_r).entries())if(n%2===0)r.push(B(s));else try{r.push(_(["{{",k([E,await T(s,e,{parser:"__ng_interpolation",__isInHtmlInterpolation:!0})]),E,"}}"]));}catch{r.push("{{",B(s),"}}");}return r}function Er({parser:t8}){return (e,r,n)=>T(P(n.node),e,{parser:t8},Y)}var Oi=Er({parser:"__ng_action"}),$i=Er({parser:"__ng_binding"}),Mi=Er({parser:"__ng_directive"});function qi(t8,e){if(e.parser!=="angular")return;let{node:r}=t8,n=r.fullName;if(n.startsWith("(")&&n.endsWith(")")||n.startsWith("on-"))return Oi;if(n.startsWith("[")&&n.endsWith("]")||/^bind(?:on)?-/u.test(n)||/^ng-(?:if|show|hide|class|style)$/u.test(n))return $i;if(n.startsWith("*"))return Mi;let s=P(r);if(/^i18n(?:-.+)?$/u.test(n))return ()=>ce(Et(bt(r,s.trim())),!s.includes("@@"));if(_r.test(s))return i=>$n(s,i)}var Mn=qi;function Hi(t8,e){let{node:r}=t8,n=P(r);if(r.fullName==="class"&&!e.parentParser&&!n.includes("{{"))return ()=>n.trim().split(/\s+/u).join(" ")}var qn=Hi;function Hn(t8){return t8==="	"||t8===`
`||t8==="\f"||t8==="\r"||t8===" "}var Vi=/^[ \t\n\r\u000c]+/,Ui=/^[, \t\n\r\u000c]+/,Wi=/^[^ \t\n\r\u000c]+/,zi=/[,]+$/,Vn=/^\d+$/,Gi=/^-?(?:[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?$/;function Yi(t8){let e=t8.length,r,n,s,i,a,o=0,u;function p(C){let A,D=C.exec(t8.substring(o));if(D)return [A]=D,o+=A.length,A}let l=[];for(;;){if(p(Ui),o>=e){if(l.length===0)throw new Error("Must contain one or more image candidate strings.");return l}u=o,r=p(Wi),n=[],r.slice(-1)===","?(r=r.replace(zi,""),d()):f();}function f(){for(p(Vi),s="",i="in descriptor";;){if(a=t8.charAt(o),i==="in descriptor")if(Hn(a))s&&(n.push(s),s="",i="after descriptor");else if(a===","){o+=1,s&&n.push(s),d();return}else if(a==="(")s+=a,i="in parens";else if(a===""){s&&n.push(s),d();return}else s+=a;else if(i==="in parens")if(a===")")s+=a,i="in descriptor";else if(a===""){n.push(s),d();return}else s+=a;else if(i==="after descriptor"&&!Hn(a))if(a===""){d();return}else i="in descriptor",o-=1;o+=1;}}function d(){let C=!1,A,D,R,F,c={},g,y,M,x,V;for(F=0;F<n.length;F++)g=n[F],y=g[g.length-1],M=g.substring(0,g.length-1),x=parseInt(M,10),V=parseFloat(M),Vn.test(M)&&y==="w"?((A||D)&&(C=!0),x===0?C=!0:A=x):Gi.test(M)&&y==="x"?((A||D||R)&&(C=!0),V<0?C=!0:D=V):Vn.test(M)&&y==="h"?((R||D)&&(C=!0),x===0?C=!0:R=x):C=!0;if(!C)c.source={value:r,startOffset:u},A&&(c.width={value:A}),D&&(c.density={value:D}),R&&(c.height={value:R}),l.push(c);else throw new Error(`Invalid srcset descriptor found in "${t8}" at "${g}".`)}}var Un=Yi;function ji(t8){if(t8.node.fullName==="srcset"&&(t8.parent.fullName==="img"||t8.parent.fullName==="source"))return ()=>Qi(P(t8.node))}var Wn={width:"w",height:"h",density:"x"},Ki=Object.keys(Wn);function Qi(t8){let e=Un(t8),r=Ki.filter(l=>e.some(f=>Object.prototype.hasOwnProperty.call(f,l)));if(r.length>1)throw new Error("Mixed descriptor in srcset is not supported");let[n]=r,s=Wn[n],i=e.map(l=>l.source.value),a=Math.max(...i.map(l=>l.length)),o=e.map(l=>l[n]?String(l[n].value):""),u=o.map(l=>{let f=l.indexOf(".");return f===-1?l.length:f}),p=Math.max(...u);return ce(q([",",E],i.map((l,f)=>{let d=[l],C=o[f];if(C){let A=a-l.length+1,D=p-u[f],R=" ".repeat(A+D);d.push(le(R," "),C+s);}return d})))}var zn=ji;function Gn(t8,e){let{node:r}=t8,n=P(t8.node).trim();if(r.fullName==="style"&&!e.parentParser&&!n.includes("{{"))return async s=>ce(await s(n,{parser:"css",__isHTMLStyleAttribute:!0}))}var Ar=new WeakMap;function Xi(t8,e){let{root:r}=t8;return Ar.has(r)||Ar.set(r,r.children.some(n=>Tt(n,e)&&["ts","typescript"].includes(n.attrMap.lang))),Ar.get(r)}var Le=Xi;function Yn(t8,e,r){let{node:n}=r,s=P(n);return T(`type T<${s}> = any`,t8,{parser:"babel-ts",__isEmbeddedTypescriptGenericParameters:!0},Y)}function jn(t8,e,{parseWithTs:r}){return T(`function _(${t8}) {}`,e,{parser:r?"babel-ts":"babel",__isVueBindings:!0})}async function Kn(t8,e,r,n){let s=P(r.node),{left:i,operator:a,right:o}=Ji(s),u=Le(r,n);return [_(await T(`function _(${i}) {}`,t8,{parser:u?"babel-ts":"babel",__isVueForBindingLeft:!0}))," ",a," ",await T(o,t8,{parser:u?"__ts_expression":"__js_expression"})]}function Ji(t8){let e=/(.*?)\s+(in|of)\s+(.*)/su,r=/,([^,\]}]*)(?:,([^,\]}]*))?$/u,n=/^\(|\)$/gu,s=t8.match(e);if(!s)return;let i={};if(i.for=s[3].trim(),!i.for)return;let a=w(!1,s[1].trim(),n,""),o=a.match(r);o?(i.alias=a.replace(r,""),i.iterator1=o[1].trim(),o[2]&&(i.iterator2=o[2].trim())):i.alias=a;let u=[i.alias,i.iterator1,i.iterator2];if(!u.some((p,l)=>!p&&(l===0||u.slice(l+1).some(Boolean))))return {left:u.filter(Boolean).join(","),operator:s[2],right:i.for}}function Zi(t8,e){if(e.parser!=="vue")return;let{node:r}=t8,n=r.fullName;if(n==="v-for")return Kn;if(n==="generic"&&Tt(r.parent,e))return Yn;let s=P(r),i=Le(t8,e);if(Rn(r)||On(r,e))return a=>jn(s,a,{parseWithTs:i});if(n.startsWith("@")||n.startsWith("v-on:"))return a=>ea(s,a,{parseWithTs:i});if(n.startsWith(":")||n.startsWith("v-bind:"))return a=>ta(s,a,{parseWithTs:i});if(n.startsWith("v-"))return a=>Qn(s,a,{parseWithTs:i})}async function ea(t8,e,{parseWithTs:r}){var n;try{return await Qn(t8,e,{parseWithTs:r})}catch(s){if(((n=s.cause)==null?void 0:n.code)!=="BABEL_PARSER_SYNTAX_ERROR")throw s}return T(t8,e,{parser:r?"__vue_ts_event_binding":"__vue_event_binding"},Y)}function ta(t8,e,{parseWithTs:r}){return T(t8,e,{parser:r?"__vue_ts_expression":"__vue_expression"},Y)}function Qn(t8,e,{parseWithTs:r}){return T(t8,e,{parser:r?"__ts_expression":"__js_expression"},Y)}var Xn=Zi;function ra(t8,e){let{node:r}=t8;if(r.value){if(/^PRETTIER_HTML_PLACEHOLDER_\d+_\d+_IN_JS$/u.test(e.originalText.slice(r.valueSpan.start.offset,r.valueSpan.end.offset))||e.parser==="lwc"&&r.value.startsWith("{")&&r.value.endsWith("}"))return [r.rawName,"=",r.value];for(let n of [zn,Gn,qn,Xn,Mn]){let s=n(t8,e);if(s)return na(s)}}}function na(t8){return async(e,r,n,s)=>{let i=await t8(e,r,n,s);if(i)return i=lr(i,a=>typeof a=="string"?w(!1,a,'"',"&quot;"):a),[n.node.rawName,'="',_(i),'"']}}var Jn=ra,Zn=new Proxy(()=>{},{get:()=>Zn}),Dr=Zn;function sa(t8){return Array.isArray(t8)&&t8.length>0}var Fe=sa;function X(t8){return t8.sourceSpan.start.offset}function J(t8){return t8.sourceSpan.end.offset}function Ze(t8,e){return [t8.isSelfClosing?"":ia(t8,e),de(t8,e)]}function ia(t8,e){return t8.lastChild&&Se(t8.lastChild)?"":[aa(t8,e),xt(t8,e)]}function de(t8,e){return (t8.next?j(t8.next):Ce(t8.parent))?"":[ge(t8,e),W(t8,e)]}function aa(t8,e){return Ce(t8)?ge(t8.lastChild,e):""}function W(t8,e){return Se(t8)?xt(t8.parent,e):et(t8)?kt(t8.next,e):""}function xt(t8,e){if(Dr(!t8.isSelfClosing),ts(t8,e))return "";switch(t8.type){case"ieConditionalComment":return "<!";case"element":if(t8.hasHtmComponentClosingTag)return "<//";default:return `</${t8.rawName}`}}function ge(t8,e){if(ts(t8,e))return "";switch(t8.type){case"ieConditionalComment":case"ieConditionalEndComment":return "[endif]-->";case"ieConditionalStartComment":return "]><!-->";case"interpolation":return "}}";case"angularIcuExpression":return "}";case"element":if(t8.isSelfClosing)return "/>";default:return ">"}}function ts(t8,e){return !t8.isSelfClosing&&!t8.endSourceSpan&&(me(t8)||Dt(t8.parent,e))}function j(t8){return t8.prev&&t8.prev.type!=="docType"&&t8.type!=="angularControlFlowBlock"&&!O(t8.prev)&&t8.isLeadingSpaceSensitive&&!t8.hasLeadingSpaces}function Ce(t8){var e;return ((e=t8.lastChild)==null?void 0:e.isTrailingSpaceSensitive)&&!t8.lastChild.hasTrailingSpaces&&!O(yt(t8.lastChild))&&!he(t8)}function Se(t8){return !t8.next&&!t8.hasTrailingSpaces&&t8.isTrailingSpaceSensitive&&O(yt(t8))}function et(t8){return t8.next&&!O(t8.next)&&O(t8)&&t8.isTrailingSpaceSensitive&&!t8.hasTrailingSpaces}function oa(t8){let e=t8.trim().match(/^prettier-ignore-attribute(?:\s+(.+))?$/su);return e?e[1]?e[1].split(/\s+/u):!0:!1}function tt(t8){return !t8.prev&&t8.isLeadingSpaceSensitive&&!t8.hasLeadingSpaces}function ua(t8,e,r){var f;let{node:n}=t8;if(!Fe(n.attrs))return n.isSelfClosing?" ":"";let s=((f=n.prev)==null?void 0:f.type)==="comment"&&oa(n.prev.value),i=typeof s=="boolean"?()=>s:Array.isArray(s)?d=>s.includes(d.rawName):()=>!1,a=t8.map(({node:d})=>i(d)?B(e.originalText.slice(X(d),J(d))):r(),"attrs"),o=n.type==="element"&&n.fullName==="script"&&n.attrs.length===1&&n.attrs[0].fullName==="src"&&n.children.length===0,p=e.singleAttributePerLine&&n.attrs.length>1&&!fe(n,e)?S:E,l=[k([o?" ":E,q(p,a)])];return n.firstChild&&tt(n.firstChild)||n.isSelfClosing&&Ce(n.parent)||o?l.push(n.isSelfClosing?" ":""):l.push(e.bracketSameLine?n.isSelfClosing?" ":"":n.isSelfClosing?E:v),l}function la(t8){return t8.firstChild&&tt(t8.firstChild)?"":Bt(t8)}function rt(t8,e,r){let{node:n}=t8;return [_e(n,e),ua(t8,e,r),n.isSelfClosing?"":la(n)]}function _e(t8,e){return t8.prev&&et(t8.prev)?"":[z(t8,e),kt(t8,e)]}function z(t8,e){return tt(t8)?Bt(t8.parent):j(t8)?ge(t8.prev,e):""}var es="<!doctype";function kt(t8,e){switch(t8.type){case"ieConditionalComment":case"ieConditionalStartComment":return `<!--[if ${t8.condition}`;case"ieConditionalEndComment":return "<!--<!";case"interpolation":return "{{";case"docType":{if(t8.value==="html"){let n=e.filepath??"";if(/\.html?$/u.test(n))return es}return e.originalText.slice(X(t8),J(t8)).slice(0,es.length)}case"angularIcuExpression":return "{";case"element":if(t8.condition)return `<!--[if ${t8.condition}]><!--><${t8.rawName}`;default:return `<${t8.rawName}`}}function Bt(t8){switch(Dr(!t8.isSelfClosing),t8.type){case"ieConditionalComment":return "]>";case"element":if(t8.condition)return "><!--<![endif]-->";default:return ">"}}function ca(t8,e){if(!t8.endSourceSpan)return "";let r=t8.startSourceSpan.end.offset;t8.firstChild&&tt(t8.firstChild)&&(r-=Bt(t8).length);let n=t8.endSourceSpan.start.offset;return t8.lastChild&&Se(t8.lastChild)?n+=xt(t8,e).length:Ce(t8)&&(n-=ge(t8.lastChild,e).length),e.originalText.slice(r,n)}var Lt=ca,pa=new Set(["if","else if","for","switch","case"]);function ha(t8,e){let{node:r}=t8;switch(r.type){case"element":if(U(r)||r.type==="interpolation")return;if(!r.isSelfClosing&&wt(r,e)){let n=gr(r,e);return n?async(s,i)=>{let a=Lt(r,e),o=/^\s*$/u.test(a),u="";return o||(u=await s(mr(a),{parser:n,__embeddedInHtml:!0}),o=u===""),[z(r,e),_(rt(t8,e,i)),o?"":S,u,o?"":S,Ze(r,e),W(r,e)]}:void 0}break;case"text":if(U(r.parent)){let n=gr(r.parent,e);if(n)return async s=>{let i=n==="markdown"?Cr(r.value.replace(/^[^\S\n]*\n/u,"")):r.value,a={parser:n,__embeddedInHtml:!0};if(e.parser==="html"&&n==="babel"){let o="script",{attrMap:u}=r.parent;u&&(u.type==="module"||u.type==="text/babel"&&u["data-type"]==="module")&&(o="module"),a.__babelSourceType=o;}return [ne,z(r,e),await s(i,a),W(r,e)]}}else if(r.parent.type==="interpolation")return async n=>{let s={__isInHtmlInterpolation:!0,__embeddedInHtml:!0};return e.parser==="angular"?s.parser="__ng_interpolation":e.parser==="vue"?s.parser=Le(t8,e)?"__vue_ts_expression":"__vue_expression":s.parser="__js_expression",[k([E,await n(r.value,s)]),r.parent.next&&j(r.parent.next)?" ":E]};break;case"attribute":return Jn(t8,e);case"front-matter":return n=>dn(r,n);case"angularControlFlowBlockParameters":return pa.has(t8.parent.name)?gn:void 0;case"angularLetDeclarationInitializer":return n=>T(r.value,n,{parser:"__ng_binding",__isInHtmlAttribute:!1})}}var rs=ha,nt=null;function st(t8){if(nt!==null&&typeof nt.property){let e=nt;return nt=st.prototype=null,e}return nt=st.prototype=t8??Object.create(null),new st}var ma=10;for(let t8=0;t8<=ma;t8++)st();function vr(t8){return st(t8)}function fa(t8,e="type"){vr(t8);function r(n){let s=n[e],i=t8[s];if(!Array.isArray(i))throw Object.assign(new Error(`Missing visitor keys for '${s}'.`),{node:n});return i}return r}var ns=fa,da={"front-matter":[],root:["children"],element:["attrs","children"],ieConditionalComment:["children"],ieConditionalStartComment:[],ieConditionalEndComment:[],interpolation:["children"],text:["children"],docType:[],comment:[],attribute:[],cdata:[],angularControlFlowBlock:["children","parameters"],angularControlFlowBlockParameters:["children"],angularControlFlowBlockParameter:[],angularLetDeclaration:["init"],angularLetDeclarationInitializer:[],angularIcuExpression:["cases"],angularIcuCase:["expression"]},ss=da,ga=ns(ss),is=ga;function as(t8){return /^\s*<!--\s*@(?:format|prettier)\s*-->/u.test(t8)}function os(t8){return `<!-- @format -->

`+t8}var us=new Map([["if",new Set(["else if","else"])],["else if",new Set(["else if","else"])],["for",new Set(["empty"])],["defer",new Set(["placeholder","error","loading"])],["placeholder",new Set(["placeholder","error","loading"])],["error",new Set(["placeholder","error","loading"])],["loading",new Set(["placeholder","error","loading"])]]);function ls(t8){let e=J(t8);return t8.type==="element"&&!t8.endSourceSpan&&Fe(t8.children)?Math.max(e,ls(se(!1,t8.children,-1))):e}function it(t8,e,r){let n=t8.node;if(me(n)){let s=ls(n);return [z(n,e),B(N.trimEnd(e.originalText.slice(X(n)+(n.prev&&et(n.prev)?kt(n).length:0),s-(n.next&&j(n.next)?ge(n,e).length:0)))),W(n,e)]}return r()}function Ft(t8,e){return O(t8)&&O(e)?t8.isTrailingSpaceSensitive?t8.hasTrailingSpaces?vt(e)?S:E:"":vt(e)?S:v:et(t8)&&(me(e)||e.firstChild||e.isSelfClosing||e.type==="element"&&e.attrs.length>0)||t8.type==="element"&&t8.isSelfClosing&&j(e)?"":!e.isLeadingSpaceSensitive||vt(e)||j(e)&&t8.lastChild&&Se(t8.lastChild)&&t8.lastChild.lastChild&&Se(t8.lastChild.lastChild)?S:e.hasLeadingSpaces?E:v}function Ne(t8,e,r){let{node:n}=t8;if(dr(n))return [ne,...t8.map(i=>{let a=i.node,o=a.prev?Ft(a.prev,a):"";return [o?[o,Qe(a.prev)?S:""]:"",it(i,e,r)]},"children")];let s=n.children.map(()=>Symbol(""));return t8.map((i,a)=>{let o=i.node;if(O(o)){if(o.prev&&O(o.prev)){let A=Ft(o.prev,o);if(A)return Qe(o.prev)?[S,S,it(i,e,r)]:[A,it(i,e,r)]}return it(i,e,r)}let u=[],p=[],l=[],f=[],d=o.prev?Ft(o.prev,o):"",C=o.next?Ft(o,o.next):"";return d&&(Qe(o.prev)?u.push(S,S):d===S?u.push(S):O(o.prev)?p.push(d):p.push(le("",v,{groupId:s[a-1]}))),C&&(Qe(o)?O(o.next)&&f.push(S,S):C===S?O(o.next)&&f.push(S):l.push(C)),[...u,_([...p,_([it(i,e,r),...l],{id:s[a]})]),...f]},"children")}function cs(t8,e,r){let{node:n}=t8,s=[];Ca(t8)&&s.push("} "),s.push("@",n.name),n.parameters&&s.push(" (",_(r("parameters")),")"),s.push(" {");let i=ps(n);return n.children.length>0?(n.firstChild.hasLeadingSpaces=!0,n.lastChild.hasTrailingSpaces=!0,s.push(k([S,Ne(t8,e,r)])),i&&s.push(S,"}")):i&&s.push("}"),_(s,{shouldBreak:!0})}function ps(t8){var e,r;return !(((e=t8.next)==null?void 0:e.type)==="angularControlFlowBlock"&&(r=us.get(t8.name))!=null&&r.has(t8.next.name))}function Ca(t8){let{previous:e}=t8;return e?.type==="angularControlFlowBlock"&&!me(e)&&!ps(e)}function hs(t8,e,r){return [k([v,q([";",E],t8.map(r,"children"))]),v]}function ms(t8,e,r){let{node:n}=t8;return [_e(n,e),_([n.switchValue.trim(),", ",n.clause,n.cases.length>0?[",",k([E,q(E,t8.map(r,"cases"))])]:"",v]),de(n,e)]}function fs(t8,e,r){let{node:n}=t8;return [n.value," {",_([k([v,t8.map(({node:s})=>s.type==="text"&&!N.trim(s.value)?"":r(),"expression")]),v]),"}"]}function ds(t8,e,r){let{node:n}=t8;if(Dt(n,e))return [z(n,e),_(rt(t8,e,r)),B(Lt(n,e)),...Ze(n,e),W(n,e)];let s=n.children.length===1&&(n.firstChild.type==="interpolation"||n.firstChild.type==="angularIcuExpression")&&n.firstChild.isLeadingSpaceSensitive&&!n.firstChild.hasLeadingSpaces&&n.lastChild.isTrailingSpaceSensitive&&!n.lastChild.hasTrailingSpaces,i=Symbol("element-attr-group-id"),a=l=>_([_(rt(t8,e,r),{id:i}),l,Ze(n,e)]),o=l=>s?on(l,{groupId:i}):(U(n)||Je(n,e))&&n.parent.type==="root"&&e.parser==="vue"&&!e.vueIndentScriptAndStyle?l:k(l),u=()=>s?le(v,"",{groupId:i}):n.firstChild.hasLeadingSpaces&&n.firstChild.isLeadingSpaceSensitive?E:n.firstChild.type==="text"&&n.isWhitespaceSensitive&&n.isIndentationSensitive?sn(v):v,p=()=>(n.next?j(n.next):Ce(n.parent))?n.lastChild.hasTrailingSpaces&&n.lastChild.isTrailingSpaceSensitive?" ":"":s?le(v,"",{groupId:i}):n.lastChild.hasTrailingSpaces&&n.lastChild.isTrailingSpaceSensitive?E:(n.lastChild.type==="comment"||n.lastChild.type==="text"&&n.isWhitespaceSensitive&&n.isIndentationSensitive)&&new RegExp(`\\n[\\t ]{${e.tabWidth*(t8.ancestors.length-1)}}$`,"u").test(n.lastChild.value)?"":v;return n.children.length===0?a(n.hasDanglingSpaces&&n.isDanglingSpaceSensitive?E:""):a([xn(n)?ne:"",o([u(),Ne(t8,e,r)]),p()])}function at(t8){return t8>=9&&t8<=32||t8==160}function Nt(t8){return 48<=t8&&t8<=57}function ot(t8){return t8>=97&&t8<=122||t8>=65&&t8<=90}function gs(t8){return t8>=97&&t8<=102||t8>=65&&t8<=70||Nt(t8)}function Pt(t8){return t8===10||t8===13}function yr(t8){return 48<=t8&&t8<=55}function It(t8){return t8===39||t8===34||t8===96}var Sa=/-+([a-z0-9])/g;function Ss(t8){return t8.replace(Sa,(...e)=>e[1].toUpperCase())}var ie=class t{constructor(e,r,n,s){this.file=e,this.offset=r,this.line=n,this.col=s;}toString(){return this.offset!=null?`${this.file.url}@${this.line}:${this.col}`:this.file.url}moveBy(e){let r=this.file.content,n=r.length,s=this.offset,i=this.line,a=this.col;for(;s>0&&e<0;)if(s--,e++,r.charCodeAt(s)==10){i--;let u=r.substring(0,s-1).lastIndexOf(`
